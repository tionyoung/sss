...
function initialize()
{
	...
	for (let i = 0; i < 6; i++)
	{
		...
		let texture = [loader.load( 'images/apple.png', render ),loader.load( 'images/cidar.png', render ),loader.load( 'images/daram.png', render ),loader.load( 'images/jjuni.png', render ),loader.load( 'images/peter.png', render ),loader.load( 'images/vinti.png', render )]
